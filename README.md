...
| :----------------------------------: | :----------------------------------: | :----------------------------------: | ------------------------------------ | :----------------------------------: | :----------------------------------: | :----------------------------------: |
| ![restaurant_search](https://github.com/user-attachments/assets/a378adfc-a404-485f-be2d-c2c5749e5f84) | <img width="320" height="963" alt="스크린샷 2025-12-05 오전 12 45 21" src="https://github.com/user-attachments/assets/efb163ec-1588-45e7-a742-c382b62de345" /> | <img width="320" height="961" alt="스크린샷 2025-12-05 오전 12 45 48" src="https://github.com/user-attachments/assets/15d89519-cf7f-4ab9-8f35-42eddef84a93" /> | <img width="320" alt="스크린샷 2025-12-04 오후 11 52 02" src="https://github.com/user-attachments/assets/18074467-bb4f-4111-8636-5d7a451e90c2" /> | ![review_compose](https://github.com/user-attachments/assets/58aca886-aeee-4ecc-ada2-b1a28f445010) | <img width="320" alt="스크린샷 2025-12-05 오전 12 07 52" src="https://github.com/user-attachments/assets/38f27f79-87fd-47e6-9e7f-9407af90e1a9" /> | ![mypage](https://github.com/user-attachments/assets/de1e8986-0e64-4b0b-b324-a6bbfa899cfb) |
...
팀 리더는 프로젝트 사업화를 목표로 전업으로 임했지만, 대부분의 개발자는 본업과 병행하며 사이드 프로젝트로 참여하고 있었습니다. 프로젝트 진행 중 팀원의 잦은 이탈과 중간 합류가 반복되었고, 일부 팀원의 소극적인 참여로 인해 개발 속도가 예상보다 더뎠습니다. 이러한 상황 속에서 개발 일정과 목표에 대한 팀 리더와 개발진 간의 이견이 좁혀지지 않았고, 결국 팀 리더의 중단 선언으로 프로젝트가 종료되었습니다.
